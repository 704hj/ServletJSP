...
<div class="page-main">
	<h2>회원가입</h2>
	<form:form modelAttribute="memberVO" action="registerUser" id="member_register">
		<form:errors element="div" cssClass="error-color"/> 
		<ul>
			<li>
				<form:label path="id">아이디</form:label>
				<form:input path="id" placeholder="*필수 입력(영문, 숫자만 4~12자)" autocomplete="off"/>
				<input type="button" id="confirm_id" value="중복체크" class="default-btn">
				<span id="message_id"></span>
				<form:errors path="id" cssClass="error-color"/>
			</li>
			<li>
				<form:label path="name">이름</form:label>
				<form:input path="name" placeholder="*필수 입력"/>
				<form:errors path="name" cssClass="error-color"/>
			</li>
			<li>
				<form:label path="nick_name">별명</form:label>
				<form:input path="nick_name"/>
				<input type="button" id="confirm_nick" value="중복체크" class="default-btn">
 				<span id="message_nick"></span>
			</li>
			<li>
				<form:label path="passwd">비밀번호</form:label>
				<form:password path="passwd" placeholder="*필수 입력(영문, 숫자만 4~12자)"/>
				<form:errors path="passwd" cssClass="error-color"/>
			</li>
			<li>
				<form:label path="phone">전화번호</form:label>
				<form:input path="phone" placeholder="*필수 입력"/>
				<form:errors path="phone" cssClass="error-color"/>
			</li>
			<li>
				<form:label path="email">이메일</form:label>
				<form:input path="email" placeholder="*필수 입력"/>
				<form:errors path="email" cssClass="error-color"/>
			</li>
			<li>
				<form:label path="zipcode">우편번호</form:label>
				<form:input path="zipcode" placeholder="*필수 입력"/>
				<input type="button" onclick="execDaumPostcode()" value="우편번호찾기" class="default-btn">
				<form:errors path="zipcode" cssClass="error-color"/>
			</li>
			<li>
				<form:label path="address1">주소</form:label>
				<form:input path="address1" placeholder="*필수 입력"/>
				<form:errors path="address1" cssClass="error-color"/>
			</li>
			<li>
				<form:label path="address2">상세주소</form:label>
				<form:input path="address2" placeholder="*필수 입력"/>
