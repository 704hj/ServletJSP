	...
	<form id="modify_form" action="modify.do" method="post">
		...
		<ul>
			<li>
				...
				<input type="text" name="title" id="title" size="30" value="${newsVO.title}" maxlength="50" class="input-check">
			</li>
			<li>
				<label for="writer">이름</label>
				<input type="text" name="writer" id="writer" size="10" value="${newsVO.writer}" maxlength="10" class="input-check">
			</li>	
			<li>
			...
			<li>
				...
				<input type="email" name="email" id="email" size="20" value="${newsVO.email}" maxlength="50" class="input-check">
			</li>	
			<li>
